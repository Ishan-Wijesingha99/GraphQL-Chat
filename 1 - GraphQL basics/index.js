...
// GraphQL is a querying language that allows to you retrieve only the bits of information you want from a database. One problem with other querying langauges is that they over-fetch or under-fetch data, this impedes performance, GraphQL solves this
...
// furthermore, we want to make sure that the entire list returned back to us isn't null, so we will add an exclamation mark to the entire array as well '[User!]!'
